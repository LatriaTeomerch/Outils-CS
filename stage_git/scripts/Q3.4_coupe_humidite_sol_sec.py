...
chemin='../data/ISBA_PROGNOSTIC.OUT_veg1_sec.nc'
...
leveldiff = [0,0.0025,0.005,0.0075,0.01,0.0125,0.015,0.0175,0.02,0.0225,0.025,0.0275,0.03,0.0325,0.035,0.0375,0.04]
plt.contourf(X, Y, Z3,leveldiff, cmap='Oranges')
py.colorbar()

py.title('veg1 - veg1 sec')
py.ylabel('profondeur du sol [m]')
